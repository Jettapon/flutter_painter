...
import 'package:example/widgets/custom_painter.dart';
...
class _FlutterPainterExampleState extends State<FlutterPainterExample> {
  GlobalKey<CustomPainterWidgetState> painterPolygonWidgetKey = GlobalKey();
          ...
          child: AppBar(
            ...
            actions: [
              ...
              IconButton(
                  ...
                  onPressed: () async {
                    if (openPolygon) {
                      await painterPolygonWidgetKey.currentState?.renderImage();
                      setState(() {
                        openPolygon = false;
                      });
                    } else {
                ...
                child: Center(
                  child: AspectRatio(
                    ...
                    child: FlutterPainter(
                      ...
                      childs: CustomPainterWidget(
                        key: painterPolygonWidgetKey,
                        paint: controller.shapePaint,
                        isOpenDraw: openPolygon,
                        onFinishDrawing: (data) {
                          print(data);
                        },
                      ),
                    ),
